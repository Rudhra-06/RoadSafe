...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        me.Column('phone', me.String(length=50), nullable=True),
    ...
    op.create_table(
        ...
        me.Column('type', me.Enum('TOW_TRUCK', 'MECHANIC', 'BATTERY_SERVICE', 'FUEL_DELIVERY', 'LOCKSMITH', name='respondertype'), nullable=False),
    ...
    op.create_table(
        ...
        me.Column('service_type', me.Enum('TOW_TRUCK', 'MECHANIC', 'BATTERY_SERVICE', 'FUEL_DELIVERY', 'LOCKSMITH', name='respondertype'), nullable=False),
    ...
    op.create_table(
        ...
        me.Column('responder_id', me.String(length=36), nullable=False),
        me.Column('status', me.Enum('OFFERED', 'ACCEPTED', 'REJECTED', 'EXPIRED', name='assignmentstatus'), nullable=False),
